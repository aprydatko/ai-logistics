    ...
    <div className="p-5">
      ...
      <section className="space-y-3 border-b border-border py-5">
        ...
        <dl className="space-y-2.5">
          ...
          <Detail label="Tokens" value={`${log.tokens} (${log.tokenDetail})`} />
      ...
      <div className="grid gap-2 border-t border-border pt-5">
        ...
        <Button
          ...
          variant="outline"
          onClick={() => void navigator.clipboard.writeText(log.prompt)}
        >
          <Copy />
          Copy prompt
        </Button>
        <Button
          className="justify-start"
          variant="outline"
          onClick={() => void navigator.clipboard.writeText(log.response)}
        >
          <Smartphone />
          Copy response
        </Button>
